<?php
	...
	$id=$_GET['idAlumnos'];
	$m="select * from alumnos where idAlumnos='$id'";
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account-circle zmdi-hc-fw"></i> DATOS DEL ALUMNO</small></h1>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="panel panel-success">
				<div class="panel-heading" style="background: linear-gradient(135deg, #71b7e6,#9b59b6);">
					<h3 class="panel-title"><i class="zmdi zmdi-refresh"></i> &nbsp; DATOS DEL ALUMNO</h3>
				</div>
				<div class="panel-body">
					<form action="updatealumno.php" method="POST" >
				    			...
				    			<div class="row">
				    				...
				    				<div class="col-xs-12">
										<div class="form-group label-floating">
										  	...
										  	<textarea name="direccion" class="form-control" rows="2" maxlength="100" value=""><?php echo $dato["Direccion"]; ?></textarea>
										</div>
										<br>
				    				</div>
									<div class="col-xs-12 col-sm-6">
										...
										<span class=details>Semestre</span>
											<select name="semestres" id="semestres" required>
												...
												<?php 
														...
														while($reg2=mysqli_fetch_array($res1)){
															if ($reg2["idSemestre"] == $dato["dSemestre"]) {
									...
									<input type="hidden" name="idAlumnos" value="<?php echo $id; ?>">
				    			</div>
				    		</div>
				    	</fieldset>
						...
						if(isset($_GET["e"])){
							if($_GET["e"]=="1") {
								echo "<br>";
								echo "<i>Se ha modificado exitosamente...</i>";
								echo "
								<script>
									setTimeout(function(){
										window.location.replace('alumnos-list.php');
									}, 3000);
								</script>
								";
							}
