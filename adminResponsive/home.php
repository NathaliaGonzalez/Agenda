...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="full-box text-center" style="padding: 30px 10px;">
			<a href="admin-list.php"><article class="full-box tile">
			...
			<a href="alumnos-list.php"><article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
					Alumnos
				</div>
				<div class="full-box tile-icon text-center">
			...
			<a href="./profesores/profesores-list.php"><article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
					Profesores
				</div>
				<div class="full-box tile-icon text-center">
			...
			<a href="./materias/materia-list.php"><article class="full-box tile">
				<div class="full-box tile-title text-center text-titles text-uppercase">
					Materias
				</div>
				<div class="full-box tile-icon text-center">
					<i class="zmdi zmdi-assignment-o zmd-fw"></i>
				</div>
				<div class="full-box tile-number text-titles">
					<p class="full-box">
