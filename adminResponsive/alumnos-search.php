					...
					<div class="table-responsive">
						...
						<?php
								if (isset($_GET['enviar'])) {
									...
									$sql= "SELECT a.idAlumnos,a.Nombre,a.Apellido,a.CIN,a.Telefono,c.nombre,s.semestre FROM alumnos a
										inner join carreras c on  a.idcarreras= c.idcarreras
										inner join semestre s on a.dSemestre=s.idSemestre where a.Nombre LIKE '%$busqueda%';";
									...
									if(mysqli_num_rows($res)>0){
										...
										while($reg=mysqli_fetch_array($res)){
											...
											<td>".$reg["semestre"]."</td>
											<td>
											<a href='actualizaralumnos.php?idAlumnos=".$reg["idAlumnos"]."' class='btn btn-success btn-raised btn-xs'>
												<i class='zmdi zmdi-refresh'></i>
											</a></td>
											<td>
											<form>
												<a href='eliminaralumno.php?id=".$reg["idAlumnos"]."' "
												?>
