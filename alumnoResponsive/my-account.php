		...
		<div class="container-fluid">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<form id="#" onsubmit="verificarPasswords(); return false" method="POST" action="updatealumno.php">
				    	<fieldset>
						...
						<!---<a class="float-end" href="eliminaralumno.php?idAlumnos=<?php echo $reg["idAlumnos"]; ?>" onclick="return confirm('Su cuenta sera eliminada permanentemente! Estas seguro que desea eliminarlo?')" title="Salir del sistema" style="color:red">
						<i class="zmdi zmdi-power"></i>
						Eliminar cuenta</a>--->
						...
						<?php 
							if(isset($_GET["e"])){
								if($_GET["e"]=="1") {
									echo "<br>";
									echo "<i>Se ha modificado exitosamente! Se redirigirá al inicio...</i>";
									echo "
									<script>
										setTimeout(function(){
											window.location.replace('../alumnoResponsive/home.php');
										}, 4000);
									</script>
									";
								}
	...
	<script>
		function verificarPasswords() {
			...
			pass3 = document.getElementById('actucontra');
				...
				console.log("ENTRO EN LA FUNCION PERRAAAAAAAAA");
